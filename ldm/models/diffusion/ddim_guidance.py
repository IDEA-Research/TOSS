...
class DDIMSampler(object):
    ...
    def sample(self,
               ...
               x_T=None,
               log_every_t=100,
               unconditional_guidance_scale2=1.,
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        # two cndition
            ...
            model_output = model_uncond + unconditional_guidance_scale * (model_t - model_uncond2) + unconditional_guidance_scale2 * (model_uncond2 - model_uncond)
