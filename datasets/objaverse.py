...
class ObjaverseDataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, root_dir, batch_size, total_view, train=None, validation=None,
                 test=None, num_workers=4, caption="rerank", **kwargs):
        super().__init__()
    ...
    def test_dataloader(self):
        return wds.WebLoader(ObjaverseData(root_dir=self.root_dir, total_view=self.total_view, validation=self.validation, caption=self.caption),\
                          batch_size=self.batch_size, num_workers=self.num_workers, shuffle=False)


class ObjaverseData(Dataset):
    def __init__(self,
        root_dir='/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/views_whole_sphere',
        image_transforms=[],
        ext="png",
        ...
        # valid_paths_recap.json
        if caption == "recaption":    
            paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/views_whole_sphere/valid_paths_recap.json"
        elif caption == 'random':
            paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/views_whole_sphere/valid_paths_12views.json"
        elif caption == "rerank":
            paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/views_whole_sphere/valid_paths_clip_recap.json"
        else:
            paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/views_whole_sphere/valid_paths.json"
