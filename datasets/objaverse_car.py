...
class ObjaverseDataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, root_dir, batch_size, total_view, train=None, validation=None,
                 test=None, num_workers=4, caption="recaption", pose_enc="freq", **kwargs):
        super().__init__()
    ...
    def train_dataloader(self):
        dataset = ObjaverseData(root_dir=self.root_dir, total_view=self.total_view, validation=False, \
                                image_transforms=self.image_transforms, caption=self.caption, pose_enc=self.pose_enc)
...
class ObjaverseData(Dataset):
    def __init__(self,
        ...
        if caption == "recaption":    
            if validation:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_recap_car_vehicles_test.json"
            else:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_recap_car_vehicles_train.json"
        elif caption == 'random':
            if validation:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_car_vehicles_test_12views.json"
            else:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_car_vehicles_train_12views.json"
        elif caption == "rerank":
            if validation:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_car_vehicles_test_clip_recap.json"
            else:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_car_vehicles_train_clip_recap.json"
        else:
            if validation:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_car_vehicles_test.json"
            else:
                paths_file = "/comp_robot/mm_generative/data/.objaverse/hf-objaverse-v1/cars-vehicles/valid_paths_car_vehicles_train.json"
    ...
    def __getitem__(self, index):
        ...
        if isinstance(self.paths_2_prompts[self.paths[index]], dict):
            ...
            prompt = self.paths_2_prompts[self.paths[index]][str(random.randint(0, total_view - 1))]
        else:
            prompt = self.paths_2_prompts[self.paths[index]]

        # if "white background" not in prompt:
        #     prompt += " in a white background"
        # print(prompt)
